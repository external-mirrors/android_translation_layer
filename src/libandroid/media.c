...
const char *AMEDIAFORMAT_KEY_BIT_RATE  = "bit-rate";
...
const char *AMEDIAFORMAT_KEY_DURATION  = "duration";
...
const char *AMEDIAFORMAT_KEY_PUSH_BLANK_BUFFERS_ON_STOP = "push-blank-buffers-on-stop";
