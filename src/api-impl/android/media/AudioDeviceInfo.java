...
public final class AudioDeviceInfo {
     ...
     */
    public int getId() {
	System.out.println("### AudioDeviceInfo 1");
        return 1;//mPort.handle().id();
    }
	...
	System.out.println("### AudioDeviceInfo 2");
	...
	System.out.println("### AudioDeviceInfo 3");
        return "123"; //mPort.address();
    }
   ...
   /**
	...
	System.out.println("### AudioDeviceInfo 4");
	return false;
	...
	System.out.println("### AudioDeviceInfo 5");
	    return false;
	...
	System.out.println("### AudioDeviceInfo 6");
        return new int[0]; //mPort.samplingRates();
    }
	...
	System.out.println("### AudioDeviceInfo 7");
        return new int[0]; //mPort.channelMasks();
    }
	...
	System.out.println("### AudioDeviceInfo 8");
        return new int[0]; // mPort.channelIndexMasks();
    }
	...
	System.out.println("### AudioDeviceInfo 9");
   ...
   /**
     ...
     */
    public int getType() {
	System.out.println("### AudioDeviceInfo 10");
        return 0;//INT_TO_EXT_DEVICE_MAPPING.get(mPort.type(), TYPE_UNKNOWN);
    }
	...
	System.out.println("### AudioDeviceInfo 11");
        return 0;//INT_TO_EXT_DEVICE_MAPPING.get(intDevice, TYPE_UNKNOWN);
    }
